...
//                imvLike.setColorFilter(R.color.red);
                imvLike.setBackground(context.getResources().getDrawable(R.drawable.icon_like));
                tvLike.setTextColor(context.getResources().getColor(R.color.red));
            } else {
//                imvLike.setBackground(context.getResources().getDrawable(R.drawable.icon_dont_like));
